...
namespace StealthGame
{
    public class MainMenu : MonoBehaviour
    {
        ...
        private Button m_MonsterButton;
        ...
        private void OnEnable()
        {
            ...
            m_MonsterButton = m_UIDocument.rootVisualElement.Q<Button>("MonsterButton");
            ...
            m_MonsterButton.clicked += () =>
            {
                //The monster scene needs to be set in the Build Profile Scene List
